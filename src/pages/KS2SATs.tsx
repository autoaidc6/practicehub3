...
const TOPICS: Topic[] = [
  ...
  { 
    name: "Geometry (Position and Direction)", 
    grade: "Expected", 
    videoUrl: "#",
    questionsUrl: "#",
    solutionsUrl: "#"
...
export default function KS2SATs({ onBack }: { onBack: () => void }) {
  ...
  const grades = ["Greater Depth", "Expected"];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <nav className="bg-[#3498db] text-white p-4 sticky top-0 z-50">
        <div className="max-w-7xl mx-auto flex items-center gap-4">
          ...
          <h1 className="text-xl font-bold tracking-wider uppercase">KS2 SATs Revision</h1>
        </div>
      </nav>
      ...
      <main className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto font-medium">
            Master your KS2 SATs with our comprehensive collection of revision videos and practice papers.
          </p>
        </div>
        ...
        <div className="bg-white p-6 rounded-xl shadow-sm border border-gray-100 mb-8">
          <div className="flex flex-col md:flex-row gap-6 items-center justify-between">
            ...
            <div className="flex flex-wrap gap-2 justify-center">
              <span className="text-sm font-bold text-gray-400 uppercase tracking-wider mr-2 self-center">Filter by Level:</span>
              {grades.map(grade => (
                <button
                  key={grade}
            ...
            <table className="w-full text-left border-collapse">
              <thead>
                <tr className="bg-[#3498db] text-white">
                  ...
                  <th className="p-4 font-bold uppercase tracking-wider border-r border-white/20 text-center w-24">Level</th>
                  ...
                  >
                    ...
                    <td className="p-4 border-r border-[#3498db]/20 text-center">
                      <span className={`inline-block px-3 py-1 rounded-md text-sm font-black ${
                        topic.grade === 'Greater Depth' ? 'bg-purple-100 text-purple-700' : 'bg-blue-100 text-blue-700'
                      }`}>
                        {topic.grade}
                      </span>
                    </td>
